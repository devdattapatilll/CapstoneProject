...
# ═══════════════════════════════════════════════════════════════════════════════
# CELL 6: Train MODEL 3 — ROAD CRACK Detection (YOLOv12)
# ═══════════════════════════════════════════════════════════════════════════════
...
metrics3 = model3.val()
print(f"Crack mAP50: {metrics3.box.map50:.3f}")
"""

# ═══════════════════════════════════════════════════════════════════════════════
# CELL 7: Train NLP text classifier
# ═══════════════════════════════════════════════════════════════════════════════
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
# CELL 8: Download all trained models
# ═══════════════════════════════════════════════════════════════════════════════
"""
import shutil, os
...
# ═══════════════════════════════════════════════════════════════════════════════
# CELL 9: After training — Place files in your project:
# ═══════════════════════════════════════════════════════════════════════════════
"""
