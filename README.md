...
| Other | NLP only | Catch-all for miscellaneous issues |

**Note:** Only 3 categories are actively detected by AI (Roads, Garbage, Road Cracks). All other issues are categorized as "Other".
